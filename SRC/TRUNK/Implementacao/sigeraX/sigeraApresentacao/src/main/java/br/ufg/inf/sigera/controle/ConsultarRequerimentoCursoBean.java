...
public class ConsultarRequerimentoCursoBean {
    ...
    static {
        ...
        TIPOS_STATUS[3] = EnumStatusRequerimento.CONCLUIDO.getNome();
        TIPOS_STATUS[4] = EnumStatusRequerimento.DEFERIDO.getNome();
        TIPOS_STATUS[5] = EnumStatusRequerimento.INDEFERIDO.getNome();
        TIPOS_STATUS[6] = EnumStatusRequerimento.CANCELADO.getNome();
    }
